...
1.  **Fork and clone the repository:**
    ```bash
    git clone https://github.com/YOUR_USERNAME/openndx-mvp.git
    cd openndx-mvp
    ```

2.  **Add the upstream remote:**
    ```bash
    git remote add upstream https://github.com/OpenNDX/openndx-mvp.git
    ```
...
-   Check existing [Issues](https://github.com/OpenNDX/openndx-mvp/issues)
